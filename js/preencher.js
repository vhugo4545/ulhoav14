...
function habilitarEdicaoTitulosAccordion() {
  const paginaValida =
    window.location.pathname === '/ulhoav14/pages/editar.html' ||
    window.location.pathname === '/pages/editar.html';

  if (!paginaValida) return;
...
function criarBotaoFlutuanteEdicaoTitulos() {
  ...
  if (document.getElementById('btn-flutuante-editar-titulos')) return;
